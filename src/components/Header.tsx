...
function Header({pageName, showCard, setShowCard}:{pageName: string, showCard: boolean, setShowCard: (showCard: boolean) => void}) {
  return (
    <>
            ...
            <ul className="flex space-x-4  items-center">
              ...
              <li className="mr-6 p-1">
                <button
                  ...
                  className="px-4 py-2 border-2 border-blue-500 hover:text-black text-white
                   bg-blue-500  hover:bg-cyan-400  rounded-md transition-colors duration-200"
                >
